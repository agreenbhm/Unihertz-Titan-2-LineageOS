...
echo 1 > /sys/devices/platform/soc/11c22000.i2c/i2c-2/2-0020/input/input6/inhibited
# Disable back screen touch
echo 1 > /sys/devices/platform/soc/11c22000.i2c/i2c-2/2-005a/input/input5/inhibited
